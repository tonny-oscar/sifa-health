  ...
  return (
    <Layout>
      ...
      <div id='homeAboutSection' className='min-h-[420px] flex flex-col justify-center md:grid grid-cols-2'>
        <h1 className='self-center text-center text-4xl font-semibold m-2'>Aligning Mind, Stars, &amp; Spirit</h1>
        <div className='bg-white bg-opacity-90 m-2 rounded-sm p-4 h-auto flex flex-col justify-around'>
          <p className='m-1'>Step into a holistic journey of self-discovery with Katie, where life coaching, astrology, and the serene wisdom of yoga converge. As a compassionate guide, Katie seamlessly blends her expertise as a life coach with celestial insights, providing a unique and transformative experience. Rooted in her yogic practice, Katie fosters mindfulness and presence in every interaction. Her nurturing approach gently empowers individuals to navigate life's complexities, unravel their true potential</p>
          <Link href='/about' className='m-1 self-center border-[1px] border-black py-2 px-5'>
            MORE ABOUT ME
          </Link>
        </div>
      </div>
